...
window_obj* create_window_obj()
{
	...
	g_win_obj->circle_surface = eext_circle_surface_conformant_add(g_win_obj->conformant);
...
Elm_Genlist_Item_Class *item_class_default = NULL;
Elm_Genlist_Item_Class *item_class_title = NULL;
Elm_Genlist_Item_Class *item_class_padding = NULL;
Elm_Genlist_Item_Class *item_class_groupindex = NULL;
Elm_Genlist_Item_Class *item_class_1text = NULL;
Elm_Genlist_Item_Class *item_class_1text_1icon = NULL;
Elm_Genlist_Item_Class *item_class_2text = NULL;
Elm_Genlist_Item_Class *item_class_1text_1icon_divider = NULL;
Elm_Genlist_Item_Class *item_class_1text_1icon_1 = NULL;
Elm_Genlist_Item_Class *item_class_2text_1icon_1 = NULL;
Elm_Genlist_Item_Class *item_class_editfield = NULL;
...
void initialize_circle_genlist_class() {
	if (!item_class_default) {
		item_class_default = elm_genlist_item_class_new();
		item_class_default->item_style = "default";
		item_class_default->func.text_get = uib_genlist_label_get;
		item_class_default->func.content_get = uib_genlist_icon_get;
		item_class_default->func.state_get = uib_genlist_state_get;
		item_class_default->func.del = uib_genlist_del;
	}

	if (!item_class_title) {
		item_class_title = elm_genlist_item_class_new();
		item_class_title->item_style = "title";
		item_class_title->func.text_get = uib_genlist_label_get;
		item_class_title->func.content_get = uib_genlist_icon_get;
		item_class_title->func.state_get = uib_genlist_state_get;
		item_class_title->func.del = uib_genlist_del;
	}

	if (!item_class_padding) {
		item_class_padding = elm_genlist_item_class_new();
		item_class_padding->item_style = "padding";
		item_class_padding->func.text_get = uib_genlist_label_get;
		item_class_padding->func.content_get = uib_genlist_icon_get;
		item_class_padding->func.state_get = uib_genlist_state_get;
		item_class_padding->func.del = uib_genlist_del;
	}

	if (!item_class_groupindex) {
		item_class_groupindex = elm_genlist_item_class_new();
		item_class_groupindex->item_style = "groupindex";
		item_class_groupindex->func.text_get = uib_genlist_label_get;
		item_class_groupindex->func.content_get = uib_genlist_icon_get;
		item_class_groupindex->func.state_get = uib_genlist_state_get;
		item_class_groupindex->func.del = uib_genlist_del;
	}

	if (!item_class_1text) {
		item_class_1text = elm_genlist_item_class_new();
		item_class_1text->item_style = "1text";
		item_class_1text->func.text_get = uib_genlist_label_get;
		item_class_1text->func.content_get = uib_genlist_icon_get;
		item_class_1text->func.state_get = uib_genlist_state_get;
		item_class_1text->func.del = uib_genlist_del;
	}

	if (!item_class_1text_1icon) {
		item_class_1text_1icon = elm_genlist_item_class_new();
		item_class_1text_1icon->item_style = "1text.1icon";
		item_class_1text_1icon->func.text_get = uib_genlist_label_get;
		item_class_1text_1icon->func.content_get = uib_genlist_icon_get;
		item_class_1text_1icon->func.state_get = uib_genlist_state_get;
		item_class_1text_1icon->func.del = uib_genlist_del;
	}

	if (!item_class_2text) {
		item_class_2text = elm_genlist_item_class_new();
		item_class_2text->item_style = "2text";
		item_class_2text->func.text_get = uib_genlist_label_get;
		item_class_2text->func.content_get = uib_genlist_icon_get;
		item_class_2text->func.state_get = uib_genlist_state_get;
		item_class_2text->func.del = uib_genlist_del;
	}

	if (!item_class_1text_1icon_divider) {
		item_class_1text_1icon_divider = elm_genlist_item_class_new();
		item_class_1text_1icon_divider->item_style = "1text.1icon.divider";
		item_class_1text_1icon_divider->func.text_get = uib_genlist_label_get;
		item_class_1text_1icon_divider->func.content_get = uib_genlist_icon_get;
		item_class_1text_1icon_divider->func.state_get = uib_genlist_state_get;
		item_class_1text_1icon_divider->func.del = uib_genlist_del;
	}

	if (!item_class_1text_1icon_1) {
		item_class_1text_1icon_1 = elm_genlist_item_class_new();
		item_class_1text_1icon_1->item_style = "1text.1icon.1";
		item_class_1text_1icon_1->func.text_get = uib_genlist_label_get;
		item_class_1text_1icon_1->func.content_get = uib_genlist_icon_get;
		item_class_1text_1icon_1->func.state_get = uib_genlist_state_get;
		item_class_1text_1icon_1->func.del = uib_genlist_del;
	}

	if (!item_class_2text_1icon_1) {
		item_class_2text_1icon_1 = elm_genlist_item_class_new();
		item_class_2text_1icon_1->item_style = "2text.1icon.1";
		item_class_2text_1icon_1->func.text_get = uib_genlist_label_get;
		item_class_2text_1icon_1->func.content_get = uib_genlist_icon_get;
		item_class_2text_1icon_1->func.state_get = uib_genlist_state_get;
		item_class_2text_1icon_1->func.del = uib_genlist_del;
	}

	if (!item_class_editfield) {
		item_class_editfield = elm_genlist_item_class_new();
		item_class_editfield->item_style = "editfield";
		item_class_editfield->func.text_get = uib_genlist_label_get;
		item_class_editfield->func.content_get = uib_genlist_icon_get;
		item_class_editfield->func.state_get = uib_genlist_state_get;
		item_class_editfield->func.del = uib_genlist_del;
	}
}
...
Elm_Object_Item* create_circle_genlist_item(Evas_Object* genlist, const char* label, const char* sub_label, const char* icon_path, const char* icon_standard, const char* end_icon_path, const char* end_icon_standard, Elm_Object_Item* parent, const char* style, Evas_Smart_Cb func, void* data){
	...
	if(!strcmp("default", style)){
	    return elm_genlist_item_append(genlist, item_class_default, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("title", style)){
	    return elm_genlist_item_append(genlist, item_class_title, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("groupindex", style)){
	    return elm_genlist_item_append(genlist, item_class_groupindex, item, parent, ELM_GENLIST_ITEM_GROUP, func, data);
	}else if(!strcmp("1text", style)){
	    return elm_genlist_item_append(genlist, item_class_1text, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("1text.1icon", style)){
	    return elm_genlist_item_append(genlist, item_class_1text_1icon, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("2text", style)){
	    return elm_genlist_item_append(genlist, item_class_2text, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("1text.1icon.divider", style)){
	    return elm_genlist_item_append(genlist, item_class_1text_1icon_divider, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("1text.1icon.1", style)){
	    return elm_genlist_item_append(genlist, item_class_1text_1icon_1, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("2text.1icon.1", style)){
	    return elm_genlist_item_append(genlist, item_class_2text_1icon_1, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}else if(!strcmp("editfield", style)){
	    return elm_genlist_item_append(genlist, item_class_editfield, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	} else {
		return elm_genlist_item_append(genlist, item_class_default, item, parent, ELM_GENLIST_ITEM_NONE, func, data);
	}
}
